package com.windsoft.tcp.library.dao;

import com.windsoft.tcp.library.bean.Book;
import com.windsoft.tcp.library.bean.BookList;
...
public class BookDao {
    ...
    private void save(){
        ...
        try {
            oos = new ObjectOutputStream(new FileOutputStream("resources//tcp//library//books"));
